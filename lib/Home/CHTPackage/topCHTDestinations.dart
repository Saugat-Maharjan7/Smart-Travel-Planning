...
import 'CApi_service.dart';
import 'Cuser_model.dart';

class ChtDestinationScreen extends StatefulWidget {

  @override
  _ChtDestinationScreenState createState() => _ChtDestinationScreenState();
}

class _ChtDestinationScreenState extends State<ChtDestinationScreen> {
                    ...
                    child: Hero(
                      ...
                      ClipRRect(
                        ...
                        child:Carousel(
                          ...
                          images: [
                            Image.asset('images/cht.jpg',
                                fit: BoxFit.fill),
                            Image.asset('images/cht1.jpg',
                                fit: BoxFit.fill),
                            Image.asset('images/cht2.jpg',
                                fit: BoxFit.fill),
                            Image.asset('images/cht3.jpg',
                                fit: BoxFit.fill),
                            Image.asset('images/cht4.jpg',
                                fit: BoxFit.fill),
                          ],
                        ),
                      ),
